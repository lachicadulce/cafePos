...
public class RightPanelBasic extends JPanel {
	...
	public RightPanelBasic(JSplitPane jsp2, ActionListener ...als) {
		...
		rightLUp.setBorder(BorderFactory.createEmptyBorder(10 , 0 , 10 , 0));
		rightLCenter.setBorder(BorderFactory.createEmptyBorder(20 , 0 , 20 , 0));
		rightLDown.setBorder(BorderFactory.createEmptyBorder(10 , 10 , 10 , 10));
		...
		rightR.setBorder(BorderFactory.createEmptyBorder(200, 10, 10, 10));
