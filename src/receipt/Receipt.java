...
public class Receipt extends PosFrame {
	public Receipt() {
		...
		String string = // 영수증 전체 내용
				"<html><center>-------------------------------------------------------------------"
						+ "<br>*정부방침에 의해 교환/환불은 반드시 영수증을" + "<br>지참하셔야 하며, 카드결제는 30일(09월08일)"
						+ "<br>이내 카드와 영수증 지참 시 가능합니다."
						+ "<br>-------------------------------------------------------------------" + "</center>"

						+ "<table style='width:100%;'>" + "<tr>" + "<td>품명</td>"
						+ "<td style='text-align:center;'>단가</td>" + "<td style='text-align:center;'>수량</td>"
						+ "<td style='text-align:right;'>금액</td>" + "</tr>" + "</table>"
						+ "-------------------------------------------------------------------"
						+ "<table style='width:100%;'>" + "<tr>" + "<td>과세매출</td>"
						+ "<td style='text-align:right;'>3000원</td>" + "</tr>" + "</table>"

						+ "<table style='width:100%;'>" + "<tr>" + "<td>부가세</td>"
						+ "<td style='text-align:right;'>3000원</td>" + "</tr>" + "</table>"

						+ "<table style='width:100%;'>" + "<tr>" + "<td>합&emsp계</td>"
						+ "<td style='text-align:right;'>3000원</td>" + "</tr>" + "</table>"

						+ "<table style='width:100%;'>" + "<tr>" + "<td>현&emsp금</td>"
						+ "<td style='text-align:right;'>3000원</td>" + "</tr>" + "</table>"
